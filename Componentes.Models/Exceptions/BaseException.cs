...
namespace Componentes.Models.Exceptions;
...
public class BaseException : Exception
{
    ...
    public BaseException(string format, Exception innerException, params object[] args) : base(
        string.Format(format, args), innerException)
    {
    }
    ...
    public BaseException(string format, HttpStatusCode statusCode, params object[] args) : base(string.Format(format,
        args))
    {
        StatusCode = statusCode;
    }

    public BaseException(string message, HttpStatusCode statusCode, Exception innerException) : base(message,
        innerException)
    {
        StatusCode = statusCode;
    }
